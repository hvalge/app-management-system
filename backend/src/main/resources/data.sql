...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'Order Web Portal', 'ORDER_SYSTEM', 'VUE',
     'Web portal for customer interactions and service requests.', 10000.00, '2023-11-02 11:00:00'),
    ('22222222-2222-2222-2222-222222222222', 'Order Processing System', 'ORDER_SYSTEM', 'JAVA',
     'Central system for processing and managing customer orders.', 20000.00, '2023-11-01 10:30:00'),
    ('33333333-3333-3333-3333-333333333333', 'Order Data Storage Solution', 'ORDER_SYSTEM', 'POSTGRESQL',
