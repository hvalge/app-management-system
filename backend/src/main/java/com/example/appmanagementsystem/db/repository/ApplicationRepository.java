...
public interface ApplicationRepository extends JpaRepository<Application, UUID> {
    ...
    @Query("select new com.example.appmanagementsystem.dto.response.ApplicationDropdownResponse(a.appCode, a.name) " +
            "FROM Application a")
    List<ApplicationDropdownResponse> findApplicationsForDropdown();
}
